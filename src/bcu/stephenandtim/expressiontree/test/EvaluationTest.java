...
public class EvaluationTest {
	...
	public void testAddition() {
		Expression expr = new Addition(new Constant(1.0), new Constant(2.0));
	...
	public void testSubtraction() {
		Expression expr = new Subtraction(new Constant(8.0), new Constant(3.0));
	...
	public void testMultiplication() {
		Expression expr = new Multiplication(new Constant(8.0), new Constant(3.0));
	...
	public void testDivision() {
		Expression expr = new Division(new Constant(10.0), new Constant(4.0));
	...
	public void testSquareRoot() {
		Expression expr = new SquareRoot(new Constant(9.0));
